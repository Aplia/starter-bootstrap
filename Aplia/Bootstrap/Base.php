...
class Base
{
    ...
    {
        // Pick the base, framework, app and extra config names from either env or $GLOBALS
        // The defaults are 'base', 'ezp' and 'prod'
        // Base: Defaults to 'base', unless BASE_CONFIGS or STARTER_BASE_CONFIGS is set
        if (getenv('BASE_CONFIGS')) {
            $baseNames = explode(",", getenv('BASE_CONFIGS'));
        ...
        if (getenv('FRAMEWORK')) {
            $frameworkNames = explode(",", getenv('FRAMEWORK'));
        ...
        if (getenv('APP_ENV')) {
            $envNames = explode(",", getenv('APP_ENV'));
        ...
        if (getenv('EXTRA_CONFIGS')) {
            $extraNames = explode(",", getenv('EXTRA_CONFIGS'));
